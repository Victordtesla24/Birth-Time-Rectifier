"""
Birth Time Rectification Agent
Main agent class that coordinates all components for birth time rectification.
"""
...
class BirthTimeRectificationAgent:
    def __init__(self):
        ...
        self.ml_engine = MLRectificationEngine(api_key) if api_key else None
    ...
    async def process_input(self, input_data: Union[Dict[str, Any], BirthData], 
        ...
        try:
            ...
            if isinstance(input_data, BirthData):
                ...
                # Extract birth details from dictionary
